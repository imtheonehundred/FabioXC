...
const form = useForm({
    ...
    is_trial: false, admin_enabled: true,
    bouquet: [] as number[], package_ids: [] as number[],
});
...
function submit() { form.post('/reseller/lines'); }
</script>
        ...
        <div class="mx-auto max-w-2xl">
            ...
            <Card class="p-6">
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="flex justify-end gap-3 pt-4 border-t"><Link href="/reseller/lines"><Button variant="outline" type="button">Cancel</Button></Link><Button type="submit" :disabled="form.processing">Create Line</Button></div>
                </form>
            </Card>
        </div>
    </ResellerLayout>
